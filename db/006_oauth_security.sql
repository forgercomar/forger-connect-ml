-- Hardening OAuth 2026-05-25 — auditoría reveló 3 CRITICAL en el flow connect-ml.
--
-- 1) oauth_states: persistir cada state emitido en /connect-ml. Validar en
--    /connect-ml/callback que existe + no se usó + TTL OK. Cierra:
--    - #3 (state OAuth no validado server-side) — comment original admitía
--      "no confiamos en el contenido del state cuando vuelve"
--
-- 2) request_nonces: anti-replay genérico para endpoints /v1/* y /connect-ml.
--    Cierra:
